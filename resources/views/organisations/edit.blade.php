    ...
    <form action="{{ route('organisations.update', $organisasi->id) }}" method="POST">
        ...
        <div class="mt-6">
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $organisasi->name }}">
            </div>
